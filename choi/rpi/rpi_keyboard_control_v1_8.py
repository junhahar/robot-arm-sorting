#!/usr/bin/env python3
"""
rpi_keyboard_control_v1_8.py — v1_7에서 MG90을 STM32 PWM 제어로 이전
================================================================
v1_7 대비 바뀐 점:
  · MG90 그리퍼를 STM32가 직접 PWM(PA6)으로 구동. RPi는 STS3215와 같은
    CAN ID 0x100에 하위 cmd 0x06으로 각도(0~180°)를 보낸다. → Nano는 ToF 전용 복귀.
  · 프레임: [0x06, angle, 0,0,0,0,0,0]  (STM32 main.cpp CMD_GRIPPER)
  · STS3215 6축(0x100) 제어는 기존과 동일.
...
실행:     python3 rpi_keyboard_control_v1_8.py
"""
...
def send_gripper(bus, angle):
    """MG90 그리퍼 각도(0~180°)를 STM32(0x100, cmd 0x06)로 송신. 클램프 후 보낸 값 반환."""
...
def main():
    ...
    print("키보드 제어 v1_8 시작 (STS3215 + MG90 그리퍼=STM32 PWM)")
