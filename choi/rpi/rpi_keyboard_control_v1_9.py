#!/usr/bin/env python3
"""
rpi_keyboard_control_v1_9.py — v1_8 + IK↔실물 1:1 매칭 캘리브 수집
================================================================
...
실행:     python3 rpi_keyboard_control_v1_9.py
"""
...
CAMERA_POSE = {1: 180.0, 2: 107.4, 3: 245.6, 4: 107.4, 5: 118.7, 6: 180.0}  # 9번
CAMERA_POSE2 = {1: 180.0, 2: 100.7, 3: 252.3, 4: 144.2, 5: 170.8, 6: 180.0}  # 8번
# CAMERA_POSE2 = {1: 160.9, 2: 99.4, 3: 260.6, 4: 151.0, 5: 164.4, 6: 223.8}
...
def main():
    ...
    print("키보드 제어 v1_9 시작 (STS3215 + MG90, IK↔실물 캘리브 수집)")
